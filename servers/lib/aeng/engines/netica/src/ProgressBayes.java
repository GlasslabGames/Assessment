...
public class ProgressBayes {
  	...
  	public static void main( String[] args ) {
		try {
			...
			boolean hadPreviousLevel = Boolean.parseBoolean( args[ 2 ] );
			System.out.println( "hadPreviousLevel = " + hadPreviousLevel );
			if( hadPreviousLevel ) {
				System.out.println( "\nStarting previous level logic...\n" );
				byte[] b = Base64.decodeBase64( args[ 3 ] );

				System.out.println( "binary arg: " + args[ 3 ] );
